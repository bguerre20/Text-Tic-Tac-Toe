...
bool MoveIsValid(int board[3][3], int row, int col);

//This function loops through the board and checks to see if anyone has won
int checkForWinner(int board[3][3]);